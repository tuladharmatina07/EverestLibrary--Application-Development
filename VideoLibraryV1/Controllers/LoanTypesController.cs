...
namespace VideoLibraryV1.Controllers
{
    public class LoanTypesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Name,Description")] LoanType loanType)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,Description")] LoanType loanType)
        {
            if (ModelState.IsValid)
            {
