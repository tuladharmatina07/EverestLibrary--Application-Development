...
namespace VideoLibraryV1.Controllers
{
    public class MemberCategoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,CategoryName,Description,TotalLoanAmount,ReturningDate,FineAmountPerDay")] MemberCategory memberCategory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,CategoryName,Description,TotalLoanAmount,ReturningDate,FineAmountPerDay")] MemberCategory memberCategory)
        {
            if (ModelState.IsValid)
            {
